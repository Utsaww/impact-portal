...
var articlepost = (req, res) => {
  ...
  console.log(req.body.keytype.length);
  ...
  //console.log(req.body.keywordFilter.length); //for testing
  ...
  if (req.body.fullTextKeyword != "") {
    //FullText Search
    let _fullText = req.body.fullTextKeyword;
    request.post(
      {
        url: "http://localhost:3000/search/getarticles",
        method: "POST",
        body: { groupkeyword: _fullText, fdate: todate, tdate: fromdate },
        json: true,
      },
      function (error, response, body) {
        query.articleid = {
          $in: body, //where in condition
        };
